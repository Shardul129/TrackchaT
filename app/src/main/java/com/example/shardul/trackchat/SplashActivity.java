package com.example.shardul.trackchat;
 ...
 */
        ...
        import com.example.shardul.trackchat.R;
        import com.example.shardul.trackchat.KenBurnsView;
...
public class SplashActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mKenBurns.setImageResource(R.drawable.com);
    ...
    private void setAnimation() {
        ...
        findViewById(R.id.Google).setAlpha(1.0F);
        Animation anim = AnimationUtils.loadAnimation(this, R.anim.translate_top_to_center);
        findViewById(R.id.Google).startAnimation(anim);
    }
}
